#ifndef SupplicantAIDLCallback_H
#define SupplicantAIDLCallback_H

#include <android/hardware/wifi/supplicant/BnSupplicantStaIfaceCallback.h>

class SupplicantStaIfaceCallback : virtual public ::android::hardware::wifi::supplicant::BnSupplicantStaIfaceCallback {
 public:
...
// ISupplicantStaIfaceCallback
  ...
  ::android::binder::Status onAssociationRejected(
      const ::android::hardware::wifi::supplicant::AssociationRejectionData
          & /*assocRejectData*/) override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ::android::binder::Status
  onAuthenticationTimeout(const ::std::vector<uint8_t> & /*bssid*/) override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ...
  ::android::binder::Status
  onDppFailure(::android::hardware::wifi::supplicant::DppFailureCode /*code*/,
  ...
  ::android::binder::Status
  onDppProgress(::android::hardware::wifi::supplicant::DppProgressCode /*code*/)
      override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ...
  ::android::binder::Status onDppSuccessConfigReceived(
      ...
      const ::android::hardware::wifi::supplicant::DppConnectionKeys
          & /*dppConnectionKeys*/) override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ...
  ::android::binder::Status
  onEapFailure(const ::std::vector<uint8_t> & /*bssid*/,
  ...
  ::android::binder::Status
  onHs20DeauthImminentNotice(const ::std::vector<uint8_t> & /*bssid*/,
                             int32_t /*reasonCode*/,
  ...
  ::android::binder::Status
  onHs20IconQueryDone(const ::std::vector<uint8_t> & /*bssid*/,
  ...
  ::android::binder::Status
  onNetworkNotFound(const ::std::vector<uint8_t> & /*ssid*/) override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ...
  ::android::binder::Status
  onPmkCacheAdded(int64_t /*expirationTimeInSec*/,
  ...
  ::android::binder::Status onQosPolicyRequest(
      ...
      const ::std::vector<::android::hardware::wifi::supplicant::QosPolicyData>
          & /*qosPolicyData*/) override {
    return ::android::binder::Status::fromStatusT(
        ::android::OK);
  }
  ...
  ::android::hardware::wifi::supplicant::StaIfaceCallbackState mStateBeforeDisconnect;
