...
// Radio types when using HAL 1.1

#ifndef nsRadioTypes1_1_H
#define nsRadioTypes1_1_H
...
using RADIO_1_0::RadioAccessFamily;
using RADIO_1_0::RadioCapability;
...
using RADIO_1_0::RadioTechnology;
using RADIO_1_0::SetupDataCallResult;
using RADIO_1_0::SignalStrength;
...
using RADIO_1_0::CardStatus;
using RADIO_1_0::Carrier;
...
using RADIO_1_0::CdmaSubscriptionSource;
using RADIO_1_0::CellIdentity;
using RADIO_1_0::CellIdentityCdma;
using RADIO_1_0::CellIdentityGsm;
using RADIO_1_0::CellIdentityLte;
using RADIO_1_0::CellIdentityTdscdma;
using RADIO_1_0::CellIdentityWcdma;
using RADIO_1_0::CellInfo;
using RADIO_1_0::CellInfoCdma;
using RADIO_1_0::CellInfoGsm;
using RADIO_1_0::CellInfoLte;
using RADIO_1_0::CellInfoTdscdma;
using RADIO_1_0::CellInfoType;
using RADIO_1_0::CellInfoWcdma;
using RADIO_1_0::ClipStatus;
using RADIO_1_0::Clir;
using RADIO_1_0::DataCallFailCause;
using RADIO_1_0::DataProfileId;
using RADIO_1_0::DataProfileInfo;
using RADIO_1_0::DataProfileInfoType;
using RADIO_1_0::DataRegStateResult;
...
using RADIO_1_0::HardwareConfig;
using RADIO_1_0::HardwareConfigModem;
using RADIO_1_0::HardwareConfigSim;
...
using RADIO_1_0::TdScdmaSignalStrength;
...
using RADIO_1_0::VoiceRegStateResult;
using RADIO_1_0::WcdmaSignalStrength;

using RADIO_1_1::KeepaliveStatus;
using RADIO_1_1::NetworkScanRequest;
using RADIO_1_1::RadioAccessNetworks;
using RADIO_1_1::RadioAccessSpecifier;
using RADIO_1_1::ScanType;

#endif  // nsRadioTypes1_1_H
